...
export default function SiteBuilderPage() {
 ...
 <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center bg-brand-50">
 ...
 <p className="mb-6 max-w-md text-sm text-ink-500">
        ...
        <button
          onClick={handleOpen}
          disabled={loading}
 className="inline-flex items-center gap-2 bg-brand-700 px-6 py-3 text-sm font-bold text-white hover:bg-brand-800 disabled:opacity-50"
        >
